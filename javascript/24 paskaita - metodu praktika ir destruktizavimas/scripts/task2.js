...
const foodArray=[
   ...
   {id:1,name:"fries",inStock:false,primeCost:0.2,cost:1.3},
   {id:2,name:"steak",inStock:true,primeCost:0.4,cost:2},
   {id:3,name:"cola",inStock:true,primeCost:0.1,cost:1},
   {id:4,name:"pepsi",inStock:true,primeCost:0.1,cost:1.1},
   {id:5,name:"dumplings",inStock:false,primeCost:0.2,cost:2},
   {id:5,name:"beetroot soup",inStock:true,primeCost:0.2,cost:1.4},
   {id:6,name:"pizza",inStock:true,primeCost:0.5,cost:2.6},
   {id:7,name:"ice cream",inStock:true,primeCost:0.1,cost:1.4},
   {id:8,name:"vegan soup",inStock:false,primeCost:0.5,cost:1.4},
   {id:9,name:"pickle soup",inStock:false,primeCost:0.1,cost:1.3},
]
...
const foodArrayReport = foodArrayProfitFromOrders.map(element=>{
   return {
      ...
      totalCost: element.cost*element.orderedAmount+"eur"
   }
});
